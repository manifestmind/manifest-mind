      ...
      <View style={[styles.content, { paddingTop: Math.max(insets.top, 14) }]}>
        ...
        <View style={styles.topBlock}>
          <View style={styles.header}>
            ...
            <Text style={styles.title}>{t.action.titre}</Text>
          </View>

          <View style={styles.progressBlock}>
            <View style={styles.progressRow}>
              <Text style={styles.progressLabel}>{t.action.etape.replace('{n}', String(cycleNumber))}</Text>
              <View style={styles.validatedBadge}>
                <Text style={styles.validatedBadgeText}>{t.action.affirmationValidee}</Text>
              </View>
            </View>
        ...
        {/* Carte action facile */}
        <Animated.View style={[styles.cardEasy, { opacity: fadeUp2, transform: [{ translateY: fadeUp2.interpolate({ inputRange: [0, 1], outputRange: [14, 0] }) }] }]}>
          <View style={styles.cardHeader}>
            <View style={styles.cardHeaderLeft}>
              <View style={[styles.cardDot, { backgroundColor: '#6AAA60' }]} />
              <Text style={styles.cardTitleEasy}>{t.action.facile}</Text>
            </View>
          ...
          <View>
            ...
            >
              ...
              <Text style={styles.btnEasyText}>{t.action.validerFacile}</Text>
            </Pressable>
            {!easyValidated && (
              <Pressable onPress={handleSkipEasy}>
                <Text style={styles.skipText}>{t.action.passer}</Text>
              </Pressable>
            )}
          </View>
        </Animated.View>
        ...
        <Animated.View style={[styles.cardHard, { opacity: fadeUp3, transform: [{ translateY: fadeUp3.interpolate({ inputRange: [0, 1], outputRange: [14, 0] }) }] }]}>
          <View style={styles.cardHeader}>
            <View style={styles.cardHeaderLeft}>
              <View style={[styles.cardDot, { backgroundColor: '#C89A10' }]} />
              <Text style={styles.cardTitleHard}>{t.action.difficile}</Text>
            </View>
          ...
          <View>
            ...
            >
              ...
              <Text style={styles.btnHardText}>{t.action.validerDifficile}</Text>
            </Pressable>
            {!hardValidated && (
