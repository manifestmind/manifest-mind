...
export const translations = {
  fr: {
    ...
    auth: {
      ...
      appleErreur: 'Connexion Apple momentanément impossible. Réessaie dans un instant ; si le souci persiste, écris-nous à {email}.',
      alertGoogle: {
    ...
    parametres: {
      ...
      abonnement: {
        ...
        restaurer: 'Restaurer mes achats Google Play',
        restaurerAcces: 'J\'ai déjà un abonnement — Me connecter',
      },
      compte: {
    ...
    activation: {
      ...
      restaureEnCours: 'Restauration réussie — activation en cours…',
      restaureAucun: 'Aucun abonnement à restaurer sur ce compte Google Play. Si tu viens de payer, patiente quelques instants.',
      restaureEchec: 'La restauration a échoué. Vérifie ta connexion et réessaie.',
    ...
    compte: {
      ...
      convertPlusTard: 'Plus tard',
      convertSucces: 'Compte créé — vérifie ta boîte mail.',
      convertEmailPris: 'Cet e-mail est déjà associé à un compte. Ton accès premium reste actif — pour créer ton compte, utilise une autre adresse.',
      afficher: 'Afficher',
      masquer: 'Masquer',
      annuler: 'Annuler',
  ...
  en: {
    ...
    auth: {
      ...
      appleErreur: 'Apple sign-in is temporarily unavailable. Try again in a moment; if it persists, email us at {email}.',
      alertGoogle: {
        titre: 'Coming soon',
    ...
    parametres: {
      ...
      abonnement: {
        ...
        restaurer: 'Restore my Google Play purchases',
        restaurerAcces: 'I already have a subscription — Log in',
      },
      compte: {
    ...
    activation: {
      ...
      restaurerAchats: 'Restore my purchases',
      restauration: 'Restoring…',
      restaureEnCours: 'Restore successful — activating…',
      restaureAucun: 'No subscription to restore on this Google Play account. If you just paid, please wait a moment.',
      restaureEchec: 'Restore failed. Check your connection and try again.',
    ...
    compte: {
      ...
      convertPlusTard: 'Later',
      convertSucces: 'Account created — check your inbox.',
      convertEmailPris: 'This email is already linked to an account. Your premium access stays active — use another address to create your account.',
      afficher: 'Show',
      masquer: 'Hide',
      annuler: 'Cancel',
  ...
  es: {
    ...
    auth: {
      ...
      appleErreur: 'El inicio de sesión con Apple no está disponible por el momento. Inténtalo de nuevo en un momento; si persiste, escríbenos a {email}.',
      alertGoogle: {
        titre: 'Próximamente',
    ...
    parametres: {
      ...
      abonnement: {
        ...
        restaurer: 'Restaurar mis compras de Google Play',
        restaurerAcces: 'Ya tengo una suscripción — Iniciar sesión',
      },
      compte: {
    ...
    activation: {
      ...
      restaurerAchats: 'Restaurar mis compras',
      restauration: 'Restaurando…',
      restaureEnCours: 'Restauración correcta — activando…',
      restaureAucun: 'Ninguna suscripción que restaurar en esta cuenta de Google Play. Si acabas de pagar, espera un momento.',
      restaureEchec: 'La restauración falló. Comprueba tu conexión e inténtalo de nuevo.',
    ...
    compte: {
      ...
      convertPlusTard: 'Más tarde',
      convertSucces: 'Cuenta creada — revisa tu correo.',
      convertEmailPris: 'Este correo ya está vinculado a una cuenta. Tu acceso premium sigue activo — usa otra dirección para crear tu cuenta.',
      afficher: 'Mostrar',
      masquer: 'Ocultar',
      annuler: 'Cancelar',
