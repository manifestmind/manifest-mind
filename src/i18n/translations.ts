...
export const translations = {
  fr: {
    ...
    activation: {
      ...
      restaureAucun: 'Aucun abonnement à restaurer sur ce compte. Si tu viens de payer, patiente quelques instants.',
  ...
  en: {
    ...
    parametres: {
      ...
      abonnement: {
        ...
        restaurer: 'Restore my purchases',
    ...
    activation: {
      ...
      restaureAucun: 'No subscription to restore on this account. If you just paid, please wait a moment.',
  ...
  es: {
    ...
    parametres: {
      ...
      abonnement: {
        ...
        restaurer: 'Restaurar mis compras',
    ...
    activation: {
      ...
      restaureAucun: 'Ninguna suscripción que restaurar en esta cuenta. Si acabas de pagar, espera un momento.',
